...
[experimental nav optimization for simple cases]: /collections/_navigation/build-time.md
...
[`child_nav_order` front matter to sort navigation pages in reverse]: /collections/_navigation/order/reverse/index.md
